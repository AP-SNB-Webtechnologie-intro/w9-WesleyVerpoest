...
const brands = ["Illy","Segafredo","Gran Maestro Italiano","Lavazza","Starbucks","Fairtrade Original"];
// array met merken van koffiebonen
...
fetch('https://randomuser.me/api/?results=6')
    ...
    .then(function (response) {
        ...
        for (let i = 0; i < response.results.length; i++) {
			...
			<div class="card-body">
			<p class="card-title text-uppercase fs-6 fw-bolder pt-3"> ${user.name.first} </p>
